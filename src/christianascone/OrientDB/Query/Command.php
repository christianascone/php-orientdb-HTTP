 ...
 * christianascone\OrientDB's SQL synthax.
 *
...
use christianascone\OrientDB\LogicException;
use christianascone\OrientDB\Query\Formatter\QueryInterface as QueryFormatterInterface;
use christianascone\OrientDB\Query\Formatter\Query as Formatter;
use christianascone\OrientDB\Query\Validator\Rid as RidValidator;
use christianascone\OrientDB\Query\Validator\Escaper as EscapeValidator;
...
abstract class Command implements CommandInterface
{
    ...
    {
        return array(
            'Target'   => "christianascone\OrientDB\Query\Formatter\Query\Target",
            'Where'    => "christianascone\OrientDB\Query\Formatter\Query\Where",
            'Class'    => "christianascone\OrientDB\Query\Formatter\Query\Regular",
            'Property' => "christianascone\OrientDB\Query\Formatter\Query\Regular",
            'Type'     => "christianascone\OrientDB\Query\Formatter\Query\Regular",
