...
/**
 * Query class to build queries execute by an christianascone\OrientDB's protocol adapter.
 *
...
namespace christianascone\OrientDB\Query;

use christianascone\OrientDB\Exception;
use christianascone\OrientDB\Query\Validator\ValidationException;
use christianascone\OrientDB\Query\Command\Credential\Grant;
use christianascone\OrientDB\Query\Command\Credential\Revoke;
...
class Query implements QueryInterface
{
    ...
    protected $commands = array(
        'select'            => 'christianascone\OrientDB\Query\Command\Select',
        'insert'            => 'christianascone\OrientDB\Query\Command\Insert',
        'delete'            => 'christianascone\OrientDB\Query\Command\Delete',
        'update'            => 'christianascone\OrientDB\Query\Command\Update',
        'update.add'        => 'christianascone\OrientDB\Query\Command\Update\Add',
        'update.remove'     => 'christianascone\OrientDB\Query\Command\Update\Remove',
        'update.put'        => 'christianascone\OrientDB\Query\Command\Update\Put',
        'grant'             => 'christianascone\OrientDB\Query\Command\Credential\Grant',
        'revoke'            => 'christianascone\OrientDB\Query\Command\Credential\Revoke',
        'class.create'      => 'christianascone\OrientDB\Query\Command\OClass\Create',
        'class.drop'        => 'christianascone\OrientDB\Query\Command\OClass\Drop',
        'class.alter'       => 'christianascone\OrientDB\Query\Command\OClass\Alter',
        'truncate.class'    => 'christianascone\OrientDB\Query\Command\Truncate\OClass',
        'truncate.cluster'  => 'christianascone\OrientDB\Query\Command\Truncate\Cluster',
        'truncate.record'   => 'christianascone\OrientDB\Query\Command\Truncate\Record',
        'references.find'   => 'christianascone\OrientDB\Query\Command\Reference\Find',
        'property.create'   => 'christianascone\OrientDB\Query\Command\Property\Create',
        'property.drop'     => 'christianascone\OrientDB\Query\Command\Property\Drop',
        'property.alter'    => 'christianascone\OrientDB\Query\Command\Property\Alter',
        'index.drop'        => 'christianascone\OrientDB\Query\Command\Index\Drop',
        'index.create'      => 'christianascone\OrientDB\Query\Command\Index\Create',
        'index.count'       => 'christianascone\OrientDB\Query\Command\Index\Count',
        'index.put'         => 'christianascone\OrientDB\Query\Command\Index\Put',
        'index.remove'      => 'christianascone\OrientDB\Query\Command\Index\Remove',
        'index.lookup'      => 'christianascone\OrientDB\Query\Command\Index\Lookup',
        'index.rebuild'     => 'christianascone\OrientDB\Query\Command\Index\Rebuild',
        'link'              => 'christianascone\OrientDB\Query\Command\Create\Link',
    );
