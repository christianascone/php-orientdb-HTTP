...
/**
 * Insert class, to build INSERT commands for christianascone\OrientDB.
 *
...
class Insert extends Command implements InsertInterface
{
    ...
    protected function getTokenFormatters()
    {
        return array_merge(parent::getTokenFormatters(), array(
            'Fields' => "christianascone\OrientDB\Query\Formatter\Query\Regular",
            'Values' => "christianascone\OrientDB\Query\Formatter\Query\Values"
        ));
    }
}
