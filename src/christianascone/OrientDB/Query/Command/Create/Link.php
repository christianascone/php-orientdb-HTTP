...
namespace christianascone\OrientDB\Query\Command\Create;
...
class Link extends Command
{
    ...
    protected function getTokenFormatters()
    {
        return array_merge(parent::getTokenFormatters(), array(
            'Inverse'             => "christianascone\OrientDB\Query\Formatter\Query\Regular",
            'SourceClass'         => "christianascone\OrientDB\Query\Formatter\Query\Regular",
            'SourceProperty'      => "christianascone\OrientDB\Query\Formatter\Query\Regular",
            'DestinationClass'    => "christianascone\OrientDB\Query\Formatter\Query\Regular",
            'DestinationProperty' => "christianascone\OrientDB\Query\Formatter\Query\Regular",
