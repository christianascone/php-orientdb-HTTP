 ...
 * permissions inside christianascone\OrientDB.
 *
...
abstract class Credential extends Command implements CredentialInterface
{
    ...
    protected function getTokenFormatters()
    {
        return array_merge(parent::getTokenFormatters(), array(
            'Role'          => "christianascone\OrientDB\Query\Formatter\Query\Regular",
            'Resource'      => "christianascone\OrientDB\Query\Formatter\Query\Regular",
            'Permission'    => "christianascone\OrientDB\Query\Formatter\Query\Regular",
        ));
    }
}
