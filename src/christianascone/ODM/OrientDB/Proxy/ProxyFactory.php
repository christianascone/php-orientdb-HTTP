...
namespace christianascone\ODM\OrientDB\Proxy;
...
use christianascone\ODM\OrientDB\Mapper\Hydration\Hydrator;
...
class ProxyFactory extends AbstractProxyFactory
{
    ...
    /**
     * @var \christianascone\ODM\OrientDB\UnitOfWork The UnitOfWork this factory is bound to.
     */
    private $uow;
     ...
     *
     * @param \christianascone\ODM\OrientDB\Manager $documentManager The DocumentManager the new factory works for.
    ...
    public function __construct(Manager $manager, $proxyDir, $proxyNamespace, $autoGenerate = AbstractProxyFactory::AUTOGENERATE_NEVER)
    {
        ...
        $proxyGenerator->setPlaceholder('baseProxyInterface', 'christianascone\ODM\OrientDB\Proxy\Proxy');
     ...
     * @return \Closure
     *
     * @throws \christianascone\ODM\OrientDB\DocumentNotFoundException
     */
