...
use christianascone\ODM\OrientDB\Mapper\Annotations\ReaderInterface as AnnotationReaderInterface;
use christianascone\ODM\OrientDB\OClassNotFoundException;
...
{
    const ANNOTATION_PROPERTY_CLASS = 'christianascone\ODM\OrientDB\Mapper\Annotations\Property';
    const ANNOTATION_CLASS_CLASS    = 'christianascone\ODM\OrientDB\Mapper\Annotations\Document';
     ...
     * classes mapped for the christianascone\OrientDB ODM.
     *
     * @return array
     */
     ...
     *
     * @param  string   $class
     * @return \christianascone\ODM\OrientDB\Mapper\Annotations\Document
     */
     ...
     * @return \christianascone\ODM\OrientDB\Mapper\Annotations\Property
     */
    ...
    /**
     * Tries to find the PHP class mapping christianascone\OrientDB's $OClass in each of the
     * directories where the documents are stored.
     *
     * @param  string $OClass
     * @return string
     * @throws \christianascone\ODM\OrientDB\OClassNotFoundException
     */
    ...
    /**
     * Searches a PHP class mapping christianascone\OrientDB's $OClass in $directory,
