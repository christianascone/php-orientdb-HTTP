...
/**
 * Class used in order to decouple christianascone\OrientDB from the christianascone dependency.
...
class Reader implements ReaderInterface
{
     ...
     * mechanism for it.
     * This reader is basically a proxy wrapping christianascone's one.
     *
    ...
    public function __construct(Cache $cacheReader = null)
    {
        ...
        AnnotationRegistry::registerAutoloadNamespace("christianascone\OrientDB");
