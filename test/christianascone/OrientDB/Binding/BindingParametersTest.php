...
class BindingParametersTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('christianascone\OrientDB\Binding\BindingParameters', BindingParameters::create(array()));
        $this->assertInstanceOf('christianascone\OrientDB\Binding\BindingParameters', BindingParameters::create(''));
