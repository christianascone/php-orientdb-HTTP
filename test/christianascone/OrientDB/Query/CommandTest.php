...
use christianascone\OrientDB\Query\Command as QueryCommand;
...
class Command extends TestCase
{
    ...
    /**
     * @expectedException christianascone\OrientDB\LogicException
     */
    ...
    /**
     * @expectedException christianascone\OrientDB\Query\TokenNotFoundException
     */
