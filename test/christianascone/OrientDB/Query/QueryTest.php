...
namespace test\christianascone\OrientDB\Query;

use test\PHPUnit\TestCase;
use christianascone\OrientDB\Query\Query;
use christianascone\OrientDB\Query\Command\Insert;
use christianascone\OrientDB\Query\Command\Select;
use christianascone\OrientDB\Query\Command\Update;
...
class QueryTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf("christianascone\OrientDB\Query\QueryInterface", $this->query);
    }
    ...
    {
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\Select', $this->query->select(array()));
    }
    ...
    {
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\InsertInterface', $this->query->insert());
    }

    public function testFields()
    {
        $this->query->insert();
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\InsertInterface', $this->query->fields(array()));
    }

    public function testInto()
    {
        $this->query->insert();
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\InsertInterface', $this->query->into('class'));
    }

    public function testValues()
    {
        $this->query->insert();
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\InsertInterface', $this->query->values(array()));
    }

    public function testTo()
    {
        $this->query->grant('a');
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\Credential\Grant', $this->query->to('c'));
    }

    public function testGrant()
    {
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\CredentialInterface', $this->query->grant('p'));
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\Credential\Grant', $this->query->grant('p'));
    }

    public function testYouCanCreateARevoke()
    {
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\CredentialInterface', $this->query->revoke('p'));
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\Credential\Revoke', $this->query->revoke('p'));
    }

    public function testCreationOfAClass()
    {
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\OClass\Create', $this->query->create('p'));
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\OClassInterface', $this->query->create('p'));
    }

    public function testRemovalOfAClass()
    {
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\OClass\Drop', $this->query->drop('p'));
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\OClassInterface', $this->query->drop('p'));
    }

    public function testRemovalOfAProperty()
    {
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\Property\Drop', $this->query->drop('p', 'h'));
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\Property', $this->query->drop('p', 'h'));
    ...
    {
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\Property\Create', $this->query->create('p', 'h'));
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\Property', $this->query->create('p', 'h'));
    ...
    {
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\Reference\Find', $this->query->findReferences("1:1"));
        //$this->assertInstanceOf('\christianascone\OrientDB\Query\Command\Reference\FindInterface', $this->query->findReferences("1:1"));
    ...
    {
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\Index\Drop', $this->query->unindex("class", "property"));
        //$this->assertInstanceOf('\christianascone\OrientDB\Query\Command\IndexInterface', $this->query->unindex("class", "property"));
    ...
    {
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\Index\Lookup', $this->query->lookup('index'));
    }

    public function testCreatingAnIndex()
    {
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\Index\Create', $this->query->index("class", "property"));
        //$this->assertInstanceOf('\christianascone\OrientDB\Query\Command\IndexInterface', $this->query->index("class", "property"));
    ...
    {
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\SelectInterface', $this->query->limit(20));
    ...
    {
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\SelectInterface', $this->query->skip(10));
    ...
    {
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\Property\Create', $this->query->create('p', 'c'));
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\Property\Create', $this->query->on('p', 'f'));

        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\Property\Drop', $this->query->drop('p', 'c'));
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\Property\Drop', $this->query->on('c', 'c'));
    ...
    {
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\OClass\Alter', $this->query->alter('c', 'p', 'v'));
    ...
    {
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\Property\Alter', $this->query->alterProperty('p', 'c', 'a', 'v'));
    ...
    {
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\Index\Put', $this->query->indexPut('i', 'k', 'v'));
    }
    ...
    {
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\Index\Remove', $this->query->indexRemove('i', 'k', 'v'));
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\Index\Remove', $this->query->indexRemove('i', 'k'));
    }

    public function testYouCanCountInAnIndex()
    {
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\Index\Count', $this->query->indexCount('i'));
    }

    /**
     * @expectedException christianascone\OrientDB\Exception
     */
    public function testAnExceptionIsRaisedWhenTryingToAccessANonExistingMethod()
    {
        $query = $this->getMock('christianascone\OrientDB\Query\Query', array('aMethodCallingABadCommand'));
    ...
    {
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\Truncate\OClass', $this->query->truncate('myFictionaryClass'));
    }

    public function testTruncatingACluster()
    {
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\Truncate\Cluster', $this->query->truncate('myFictionaryCluster', true));
    }

    public function testTruncatingARecord()
    {
        $this->assertInstanceOf('\christianascone\OrientDB\Query\Command\Truncate\Record', $this->query->truncate('12:0'));
    }
}
