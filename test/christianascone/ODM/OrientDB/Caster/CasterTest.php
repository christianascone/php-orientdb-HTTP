...
namespace test\christianascone\ODM\OrientDB\Caster;
...
class CasterTest extends TestCase
{
    ...
    /**
     * @dataProvider getForcedBooleans
     * @expectedException \christianascone\ODM\OrientDB\Caster\CastingMismatchException
     */
    ...
    {
        return array(
            array(new \christianascone\OrientDB\Binding\Client\Http\CurlClientResponse("1\r\n\r\n2")),
        );
    }
    ...
    {
        $property = $this->getMock('christianascone\ODM\OrientDB\Mapper\Annotations\Property', null, array(array('cast' => 'embedded')));
