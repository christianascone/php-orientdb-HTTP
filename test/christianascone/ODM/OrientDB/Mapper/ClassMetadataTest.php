...
namespace test\christianascone\ODM\OrientDB\Mapper;

use christianascone\ODM\OrientDB\Mapper\Annotations\Property;
use test\PHPUnit\TestCase;
use christianascone\ODM\OrientDB\Mapper;
use christianascone\ODM\OrientDB\Mapper\ClassMetadata;
...
class ClassMetadataTest extends TestCase
{
    ...
    {
        $this->metadata = new ClassMetadata('test\christianascone\ODM\OrientDB\Mapper\Mapped');
    ...
    {
        $this->assertEquals('test\christianascone\ODM\OrientDB\Mapper\Mapped', $this->metadata->getName());
    }
