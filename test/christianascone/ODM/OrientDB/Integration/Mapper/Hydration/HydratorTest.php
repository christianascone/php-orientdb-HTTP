...
namespace test\christianascone\ODM\OrientDB\Integration\Mapper\Hydration;
...
class HydratorTest extends TestCase
{
    ...
    {
        $manager = $this->createManager(array('document_dirs' => array('test/christianascone/ODM/OrientDB/Document/Stub' => 'test')));
    ...
    public function testHydratingNullableAttributes()
    {
        ...
        $this->assertInstanceOf('test\christianascone\ODM\OrientDB\Document\Stub\Contact\EmptyAddress', $result);
    }
    ...
    public function testAJsonGetsConvertedToAnObject()
    {
        ...
        $this->assertInstanceOf('test\christianascone\ODM\OrientDB\Document\Stub\Contact\Address', $result);
    }

    /**
     * @expectedException \christianascone\ODM\OrientDB\DocumentNotFoundException
     */
    ...
    /**
     * @expectedException \christianascone\ODM\OrientDB\OClassNotFoundException
     */
    ...
    {
        $collection = $this->hydrator->hydrateCollection($this->jsonCollection);
        $this->assertInstanceOf('test\christianascone\ODM\OrientDB\Document\Stub\Contact\Address', $collection[0] );
        $this->assertInstanceOf('test\christianascone\ODM\OrientDB\Document\Stub\City', $collection[1] );
    }

    public function testCongowOrientObjectsOfDifferentClassesCanBeMappedByASinglePopo()
    {
        $collection = $this->hydrator->hydrateCollection($this->jsonCollection);
        $this->assertInstanceOf('test\christianascone\ODM\OrientDB\Document\Stub\Contact\Address', $collection[2] );
    }
}